...
import types
import time
from multiprocessing import Process, Queue, TimeoutError, Pool, Value, Condition, Manager
...
def parse_args(args, namespace):
    ...
    parser.add_argument('-thr', '--queue_threshold', metavar='queue_threshold', 
                    type=int, help='queue size threshold for auto-scaling', default=10)
